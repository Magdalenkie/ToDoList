...
public class BoardTestSuite {
    ...
    public void testTaskAdd() {
        ...
        //Then
        Assert.assertEquals("task to do", board.getToDoList().getTask().get(0));
        Assert.assertEquals("task in progress", board.getInProgressList().getTask().get(0));
        Assert.assertEquals("task done", board.getDoneList().getTask().get(0));
    }
}
